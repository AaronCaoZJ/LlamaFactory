...
#
# Usage:  bash scripts/qwen3_5/mikomiko_tag/test_mikomiko.sh [STEP] [GPU]
#   STEP : checkpoint step to test (default 17296). Waits until that checkpoint is fully saved.
...
RUN_DIR="${PRED_DIR}/runs/evalmini_step_${CKPT_STEP}"
