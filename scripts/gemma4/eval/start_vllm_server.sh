...
BASE_MODEL="/workspace1/zhijun/hf_download/models/gemma4-12B-it"
SAVES="/workspace1/zhijun/LlamaFactory/saves/gemma4-12b/robot"
...
PORT="${PORT:-8104}"; GPU_UTIL="${GPU_UTIL:-0.7}"; MAX_LEN="${MAX_LEN:-8192}"
